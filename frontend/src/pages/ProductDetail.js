  ...
  return (
    <div className="container" style={{ padding: '2rem 0', minHeight: '50vh' }}>
      <h1 style={{ fontSize: '2.25rem', fontWeight: 'bold', marginBottom: '1rem' }}>
        {ProductDetail === 'ProductDetail' ? 'Product Details' : 
          ProductDetail === 'UserDashboard' ? 'User Dashboard' :
          ProductDetail === 'AdminDashboard' ? 'Admin Dashboard' : ProductDetail}
      </h1>
      <p style={{ color: '#6b7280', marginBottom: '1.5rem' }}>
        {ProductDetail === 'Products' ? 'Browse our complete collection of authentic Himalayan footwear.' :
          ...
          ProductDetail === 'Cart' ? 'Review your shopping cart items.' :
          ProductDetail === 'UserDashboard' ? 'Manage your account and orders.' :
          ProductDetail === 'AdminDashboard' ? 'Administrator panel for managing the store.' :
